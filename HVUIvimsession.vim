...
set shortmess=aoO
badd +112 README.txt
badd +21 \Users\J2Alpha\code\ruby\HVUI\frontend.rb
badd +1 \Users\J2Alpha\code\ruby\HVUI\EMcore.rb
badd +0 \Users\J2Alpha\code\ruby\HVUI\plasmacore.rb
args README.txt
edit \Users\J2Alpha\code\ruby\HVUI\plasmacore.rb
...
exe '1resize ' . ((&lines * 38 + 31) / 63)
exe 'vert 1resize ' . ((&columns * 52 + 88) / 177)
exe '2resize ' . ((&lines * 22 + 31) / 63)
exe 'vert 2resize ' . ((&columns * 52 + 88) / 177)
exe 'vert 3resize ' . ((&columns * 124 + 88) / 177)
argglobal
...
silent! normal! zE
let s:l = 66 - ((22 * winheight(0) + 19) / 38)
...
wincmd w
argglobal
edit \Users\J2Alpha\code\ruby\HVUI\frontend.rb
nnoremap <buffer> <silent> g} :exe        "ptjump =RubyCursorIdentifier()"
nnoremap <buffer> <silent> } :exe          "ptag =RubyCursorIdentifier()"
nnoremap <buffer> <silent> g] :exe      "stselect =RubyCursorIdentifier()"
nnoremap <buffer> <silent> g :exe        "stjump =RubyCursorIdentifier()"
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 30 - ((11 * winheight(0) + 11) / 22)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
30
...
wincmd w
argglobal
edit \Users\J2Alpha\code\ruby\HVUI\EMcore.rb
nnoremap <buffer> <silent> g} :exe        "ptjump =RubyCursorIdentifier()"
nnoremap <buffer> <silent> } :exe          "ptag =RubyCursorIdentifier()"
nnoremap <buffer> <silent> g] :exe      "stselect =RubyCursorIdentifier()"
nnoremap <buffer> <silent> g :exe        "stjump =RubyCursorIdentifier()"
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 112 - ((33 * winheight(0) + 30) / 61)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
112
